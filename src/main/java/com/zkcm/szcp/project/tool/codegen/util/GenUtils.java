package com.zkcm.szcp.project.tool.codegen.util;
...
import com.zkcm.szcp.common.exception.CheckedException;
import com.zkcm.szcp.common.exception.CustomException;
import com.zkcm.szcp.project.tool.codegen.domain.ColumnEntity;
...
public class GenUtils {
    ...
    private String getFileName(String template, String className, String packageName, String moduleName) {
        String packagePath = Constants.BACK_END_PROJECT + File.separator + "src" + File.separator + "main" + File.separator + "java" + File.separator;
        ...
        if (template.contains(MAPPER_XML_VM)) {
            return Constants.BACK_END_PROJECT + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "mapper" + File.separator + className + "Mapper.xml";
        }
        ...
        if (template.contains(INDEX_VUE_VM)) {
            return Constants.FRONT_END_PROJECT + File.separator + "src" + File.separator + "views" +
                    File.separator + moduleName + File.separator + className.toLowerCase() + File.separator + "index.vue";
        }

        if (template.contains(API_JS_VM)) {
            return Constants.FRONT_END_PROJECT + File.separator + "src" + File.separator + "api" + File.separator + moduleName + File.separator + className.toLowerCase() + ".js";
        }

        if (template.contains(CRUD_JS_VM)) {
            return Constants.FRONT_END_PROJECT + File.separator + "src" + File.separator + "const" +
